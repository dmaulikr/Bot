...
#define LOG_PRINT(logLevel,logLevelStr,logEnable, function, line, format, ...) \
{\
if (logEnable && glocalLogLevel <= logLevel) \
{\
va_list argList;\
...
{
    return [NSTemporaryDirectory() stringByAppendingPathComponent:@"HNABimLog.log"];
}
/**
...
{
    LOG_PRINT(FF_LOG_LEVEL_DEBUG, @"debug", ENABLELOG, function, (long)line, format, ...);
}
 ...
 * @description:
 **/
+ (void) info:(NSString*)moduleTag logEnable:(BOOL)logEnable function:(NSString*)function line:(NSInteger)line format:(NSString*)format, ...
{
    LOG_PRINT(FF_LOG_LEVEL_INFO,  @"info", ENABLELOG, function, (long)line, format, ...);
}
 ...
 * @description:
 **/
+ (void) warning:(NSString*)moduleTag logEnable:(BOOL)logEnable function:(NSString*)function line:(NSInteger)line format:(NSString*)format, ...
{
    LOG_PRINT(FF_LOG_LEVEL_WARNING,  @"warning", ENABLELOG, function, (long)line, format, ...);
}
...
{
    LOG_PRINT(FF_LOG_LEVEL_ERROR,  @"error", ENABLELOG, function, (long)line, format, ...);
}
